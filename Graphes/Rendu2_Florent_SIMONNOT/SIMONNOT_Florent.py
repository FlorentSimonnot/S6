"""
Auteur : Florent SIMONNOT
Groupe : G3
Représentation de graphes orientés grâce à un dictionnaire.
"""
...
class graphesOrientes(object) :	
	...
	def arcs(self) : 
		...
		>>> G.ajouter_arcs([(0, 1), (1, 0), (2, 2), (2, 5), (4, 3), (2, 1), (4, 0)])
		>>> G.arcs()
		[(0, 1), (1, 0), (2, 1), (2, 2), (2, 5), (4, 0), (4, 3)]
		"""
		arcs = []
	...
	def sommets(self) : 
		...
		>>> G = graphesOrientes()
    	>>> G.ajouter_sommets([0, 1, 2, 4, 5, 10])
    	>>> G.sommets()
    	[0, 1, 2, 4, 5, 10]
    	"""
	...
	def nombre_boucles(self):
		...
		>>> G = graphesOrientes()
    	>>> G.ajouter_sommets([0, 1, 2, 3, 4, 5])
    	>>> G.ajouter_arcs([(0, 1), (1, 0), (2, 2), (2, 5), (4, 3), (2, 1), (4, 0), (4, 4)])
    	>>> G.nombre_boucles()
    	2
		"""
	...
	def retirer_arc(self, u, v) : 
		...
		{0: {1}, 1: {0}, 2: {1, 2, 5}, 3: set(), 4: {0, 3}, 5: set()}
		>>> G.retirer_arc(2, 2)
		>>> print(G.dictionnaire)
		{0: {1}, 1: {0}, 2: {1, 5}, 3: set(), 4: {0, 3}, 5: set()}
    	"""
		if self.contient_sommet(u) and self.contient_sommet(v) : 
	...
	def retirer_arcs(self, iterable) : 
		...
		>>> print(G.dictionnaire)
		{0: {1}, 1: {0}, 2: {1, 2, 5}, 3: set(), 4: {0, 3}, 5: set()}
		>>> G.retirer_arcs([(2, 2), (4, 3)])
		>>> print(G.dictionnaire)
		{0: {1}, 1: {0}, 2: {1, 5}, 3: set(), 4: {0}, 5: set()}
    	"""
		for u, v in iterable : 
...
def main():
    ...
    GAlpha.ajouter_arcs([('a', 'b'), ('b', 'a'), ('c', 'c'), ('c', 'f'), ('e','d'), ('c', 'b'), ('e', 'a')])
    ...
    G2.ajouter_arcs([(0, 2), (3, 10), (2, 0), (4, 0), (4, 3), (10, 10)])
    ...
    G3.ajouter_arcs([(0, 1), (1, 0), (2, 2), (2, 5), (4, 3), (2, 1), (4, 0)])
    ...
    G4 = graphesOrientes()
    G4.ajouter_sommets([0, 1, 2, 3, 4, 5])
    creer_dot(G4, "oriente4.dot")
    creer_dot(foret_profondeur(G4), "foretProfondeur4.dot")
    creer_dot(foret_largeur(G4), "foretLargeur4.dot")
"""
    G5 = graphesOrientes()
    G5.ajouter_sommets([0, 1, 2, 3, 4, 5, 6])
    G5.ajouter_arcs([(0, 1), (0, 2), (0, 4), (1, 3), (1, 5), (2, 6), (4, 5)])
    creer_dot(G5, "oriente5.dot")
    creer_dot(foret_profondeur(G5), "foretProfondeur5.dot")
    creer_dot(foret_largeur(G5), "foretLargeur5.dot")
