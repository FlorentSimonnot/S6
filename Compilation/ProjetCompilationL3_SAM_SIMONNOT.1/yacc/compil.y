...
%type <intval> F Exp EB TB FB M E T NombreSigne Litteral LitteralDefine ListExp DeclInit ListPrint
...
Prog: DeclInclude DeclDefine DeclConsts DeclVars DeclFoncts
    ; 
...
EnTeteFonct:
       TYPE IDENT '(' Parametres ')'    {   strcpy(name_function, $2);
                                            addFun($2, getType($1));
                                            createStack();
                                            parameters = 0;
                                        }
